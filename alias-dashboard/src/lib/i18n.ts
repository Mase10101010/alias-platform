...
export const translations = {
  en: {
    ...
    authHeroDescription:
      'Create your restaurant workspace, configure your AI concierge, and begin the 14-day trial in minutes.',
  ...
  it: {
    ...
    authHeroDescription:
      'Crea il workspace del tuo ristorante, configura il tuo concierge AI e inizia la prova di 14 giorni in pochi minuti.',
    authPrivateBeta: 'Private beta',
  ...
  es: {
    ...
    authHeroDescription:
      'Crea el espacio de trabajo de tu restaurante, configura tu conserje de IA y comienza la prueba de 14 días en minutos.',
  ...
  fr: {
    ...
    authHeroDescription:
      'Créez l’espace de travail de votre restaurant, configurez votre concierge IA et démarrez l’essai de 14 jours en quelques minutes.',
  ...
  de: {
    ...
    authHeroDescription:
      'Erstellen Sie Ihren Restaurant-Workspace, konfigurieren Sie Ihren KI-Concierge und starten Sie die 14-Tage-Testversion in wenigen Minuten.',
    authPrivateBeta: 'Private Beta',
